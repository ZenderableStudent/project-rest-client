...
public class ProjektServiceImpl implements ProjektService {
 ...
 if (projekt.getProjektId() != null) { // modyfikacja istniej¹cego projektu
 ...
 // po dodaniu projektu zwracany jest w nag³ówku Location - link do utworzonego zasobu
 ...
 // je¿eli us³uga mia³aby zwracaæ utworzony obiekt a nie link to trzeba by u¿yæ
